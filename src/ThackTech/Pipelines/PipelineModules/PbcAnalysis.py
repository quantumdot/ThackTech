...
class PbcAnalysis(PipelineModule):
	...
	# if not input_bam:
		# #logger.write('input_bam is required, explicitly or in input_JSON')
		# raise Exception('input_bam is required, explicitly or in input_JSON')

	# if paired_end == None:
		# #logger.write('paired_end is required, explicitly or in input_JSON')
		# raise Exception('input_bam is required, explicitly or in input_JSON')
